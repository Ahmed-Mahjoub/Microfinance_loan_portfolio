...
print("Sum of all loans is :" , total_of_all_loans)
...
print("The future vale is:", future_value)
...
fair_price = future_value / (1 + (discount_rate/compounded_monthly)) ** remaining_months
print(f"The fair value of the loan is: {fair_price: ,.2f}")
...
def calculate_present_value(future_value,remaining_months, annual_discount_rate):
    present_value_function = future_value / (1 + annual_discount_rate)**remaining_months
    return(present_value_function)

annual_discount_rate = 0.2/12  
new_remaining_months = 12


# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
# YOUR CODE HERE!
new_present_value = calculate_present_value(future_value,new_remaining_months,annual_discount_rate)
